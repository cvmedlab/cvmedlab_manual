...
-   [gtExtras](https://jthomasmock.github.io/gtExtras/) - extension for {gt}
...
-   [shiny](https://shiny.rstudio.com/) - builds interactive web apps from R
...
-   [daggity](http://www.dagitty.net/primer/) - for creating DAGs and much more
