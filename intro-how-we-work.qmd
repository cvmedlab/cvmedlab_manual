...
-   lab manual: [This repository](https://github.com/cvmedlab/cvmedlab_manual/) contains the lab manual, see section \ref{#sec-coding} for other useful resources
